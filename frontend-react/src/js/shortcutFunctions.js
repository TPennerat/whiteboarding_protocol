...
const shortcutFunctions = {
  ...
  setTool_mouse: defineShortcut(() =>
    $(".whiteboard-tool[tool=mouse]").click()
  ),
  setTool_recSelect: defineShortcut(() =>
    $(".whiteboard-tool[tool=recSelect]").click()
  ),
  ...
  shareWhiteboard: defineShortcut(
